...
const (
	// CvNone no Cross Validation
	CvNone = iota
	// CvLoo Leave One Out Cross Validation (Exhaustive cross-validation)
	CvLoo
	// CvLpo Leave P Out Cross Validation (Exhaustive cross-validation)
	CvLpo
	// CvKfold K-Fold Cross Validation (Non-exhaustive cross-validation)
	CvKfold
	// CvRepKfold Repeated K-Fold Cross Validation (Non-exhaustive cross-validation)
	CvRepKfold
	// CvMonteCarlo Monte Carlo Cross Validation, also called Repeated random sub-sampling validation (Non-exhaustive cross-validation)
	CvMonteCarlo
)
